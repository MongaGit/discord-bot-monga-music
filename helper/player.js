...
class Player {
      ...
      await lib.discord.channels['@0.2.0'].messages.update({
        ...
        content: `**[ Song List ]**\n${currentQueue
          ...
          currentQueue.length > 5
            ? '\n**' + (currentQueue.length - 5) + '** Mais musicas na fila..'
            : ''
        }`,
      });
    }
  ...
  static async reset({channel_id, guild_id, keyDetails} = {}) {
    ...
    const embed = {
      title: `Monga Music Box 🎵`,
      url: `https://monga.dev.br`,
      description: `Qualquer coisa que escrever nessa canal sera interpretado como um titulo de video`,
      color: 0xd43790,
      image: {
    ...
    await lib.discord.channels['@0.2.0'].messages.update({
      ...
      channel_id: keyDetails.channelId,
      embed,
      content: `**[ Musicas na fila ]**\nEntre em um canal de voz e insira nome ou url da musica aqui.`,
      components: [
        {
          type: 1,
          components: [
